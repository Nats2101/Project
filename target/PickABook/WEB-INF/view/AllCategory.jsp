 ...
 <table class="table table-striped;">
  ...
  <c:forEach var="category" items="${category}">
	...
	<td>
			...
			<a href="EditCategory?id=${category.id}" >  <button type="button" class="btn btn-warning">Edit</button></a>
			<a href="DeleteCategory?id=${category.id}" >  <button type="button" class="btn btn-danger">Delete</button></a>
			</sec:authorize>
	</td>
	</tr>
