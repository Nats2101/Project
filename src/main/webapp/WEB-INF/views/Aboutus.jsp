    ...
    <div class="col-sm-9" style="background-color:white;">.<br><br><Br><br><br><Br>
      ...
      <div class="row">
        <div class="col-sm-2 text-center">
          <img src="assets/images/A3.jpg" height="75" width="65" alt="Avatar">
        </div>
        <div class="col-sm-10">
        ...
        <div class="col-sm-2 text-center">
          <img src="assets/images/A5.jpg"  height="75" width="65" alt="Avatar">
        </div>
        <div class="col-sm-10">
          ...
          <div class="row">
            <div class="col-sm-2 text-center">
              <img src="assets/images/A1.jpg" height="75" width="65" alt="Avatar">
            </div>
            <div class="col-xs-10">
